...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2023 at 05:50 AM
...
-- --------------------------------------------------------
/* bank name ,branch name, ac holder, acc no,ifsc code */
...
INSERT INTO 'bank_details' ('bank_name', 'branch_name', 'account_holder','account_number', 'ifsc_code') 
            VALUES ('$bank_name', '$branch_name', '$account_holder','$account_number', '$ifsc_code');
...
(2, 'hensi', 'd', 'ghevariya', '987654320', 'varachcha', 'hensi@gmail.com', '1', 0);
...
('hensi d ghevariya', 'hensi@gmail.com', 1234567896, 'good');
...
(4, '838824', 1, 2, 'Business', 200000, 2, 0, '0000-00-00 00:00:00', '2023-03-20 11:36:24');
...
CREATE TABLE `upload` (
  ...
  `pan_card` blob NOT NULL,
  `electricity_bill` blob NOT NULL,
  `incomeTax_returns` blob NOT NULL,
  `income_certificate` blob NOT NULL,
  `Bean_Reserve` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `upload` (`borrower_id`, `aadhar_card`, `pan_card`, `electricity_bill`, `incomeTax_returns`, `income_certificate`, `Bean_Reserve`) VALUES
(0, 0x312e6a70672e6a7067, 0x322e6a70672e6a7067, 0x332e6a70672e6a7067, 0x352e6a70672e6a7067, 0x312e6a70672e6a7067, 0x322e6a70672e6a7067);
...
(16, 0, 'hensi d ghevariya', '', '', 'hensi', 'hensi123', 1);
