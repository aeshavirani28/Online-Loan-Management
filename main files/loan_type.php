							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_loan_type" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_loan_type').click(function(){
		_conf("Are you sure to delete this Loan Type?","delete_loan_type",[$(this).attr('data-id')])
	})
