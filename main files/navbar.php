...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=user_registration" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> User_registration</a>
				<a href="index.php?page=user_messages" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> User_messages</a>
				<a href="index.php?page=bank" class="nav-item nav-bank"><span class='icon-field'><i class="fa fa-users"></i></span> Bank Details </a>	
