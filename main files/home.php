...
<style>
   ...
   .card-body2{
    background-color:rgba(57, 56, 56, 0.88);
   }
   .card-body3{
    background-color:rgba(57, 56, 56, 0.88);
   }
...
<div class="containe-fluid">
	...
	<div class="row mt-3 ml-3 mr-3">
			...
			<div class="card">
				...
				<!-- <div class="col-md-3">
                        <div class="card-body1  text-white mb-3 " >
                            <div class="card-body">
                ...
                <div class="col-md-3">
                        <div class="card-body2  text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                  ...
                  <div class="col-md-3">
                        <div class="card-body3  text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                     ...
                     <div class="col-md-3">
                        <div class="card-body4  text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
